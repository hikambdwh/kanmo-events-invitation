            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="h-12" src="{{ asset('img/kei_logo.png') }}" alt="Event Invitation Logo" />
                    </a>
                </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                @if (auth()->user()->isAdmin())
                    ...
                    <x-responsive-nav-link :href="route('staff.scanner')" :active="request()->routeIs('staff.scanner')">
                        {{ __('Scanner') }}
                    </x-responsive-nav-link>
                @endif
